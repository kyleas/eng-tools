...
|-------|------|--------------|
| eng-core | Shared engineering core (units, IDs, numeric, timing) | Domain physics models, solving orchestration |
| tf-core | Compatibility shim for legacy imports | New core feature ownership |
...
Crate/package naming convention:
- Shared cross-repo engineering infrastructure: `eng-*` package names
- ThermoFlow-specific crates/workflows: `tf-*` package names
