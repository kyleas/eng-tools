...
pub struct FluidSweepParameters {
    /// Species being swept (e.g., "N2", "H2O")
    pub species: String,
    /// Sweep variable name (e.g., "Temperature", "Pressure")
    pub sweep_variable: String,
    /// Start value with units (e.g., "300K", "1bar")
    pub start_value: String,
    /// End value with units (e.g., "400K", "10bar")
    pub end_value: String,
    /// Number of points to generate
    #[serde(default = "default_sweep_points")]
    pub num_points: usize,
    /// Sweep spacing: "Linear" or "Logarithmic"
    #[serde(default = "default_sweep_type")]
    pub sweep_type: String,
    /// Fixed property control (e.g., if sweeping T, fix P)
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub fixed_property_name: Option<String>,
    /// Fixed property value with units (e.g., "101325Pa", "300K")
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub fixed_property_value: Option<String>,
}

impl Default for FluidSweepParameters {
    fn default() -> Self {
        Self {
            ...
            fixed_property_name: Some("Pressure".to_string()),
            fixed_property_value: Some("101325Pa".to_string()),
        }
    }
}
