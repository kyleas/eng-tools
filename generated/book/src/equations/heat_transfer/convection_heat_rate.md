...
### Python
```python
engpy.equations.heat_transfer.convection_heat_rate.solve_a(q_dot="...", h="...", t_s="...", t_inf="...")
# helper layer
engpy.helpers.format_value(engpy.equations.heat_transfer.convection_heat_rate.solve_a(q_dot="...", h="...", t_s="...", t_inf="..."), "<in_unit>", "<out_unit>")
engpy.equations.meta.equation_ascii("heat_transfer.convection_heat_rate")
engpy.helpers.equation_targets_text("heat_transfer.convection_heat_rate")
engpy.helpers.equation_variables_table("heat_transfer.convection_heat_rate")
engpy.helpers.equation_target_count("heat_transfer.convection_heat_rate")
```
...
=ENG_EQUATION_TARGETS_TEXT("heat_transfer.convection_heat_rate")
=ENG_EQUATION_VARIABLES_TABLE("heat_transfer.convection_heat_rate")
=ENG_EQUATION_TARGET_COUNT("heat_transfer.convection_heat_rate")
```
