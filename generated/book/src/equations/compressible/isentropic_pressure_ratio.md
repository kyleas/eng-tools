...
### Python
```python
engpy.equations.compressible.isentropic_pressure_ratio.solve_m(p_p0="...", gamma="...")
# helper layer
engpy.helpers.format_value(engpy.equations.compressible.isentropic_pressure_ratio.solve_m(p_p0="...", gamma="..."), "<in_unit>", "<out_unit>")
engpy.equations.meta.equation_ascii("compressible.isentropic_pressure_ratio")
engpy.helpers.equation_targets_text("compressible.isentropic_pressure_ratio")
engpy.helpers.equation_variables_table("compressible.isentropic_pressure_ratio")
engpy.helpers.equation_target_count("compressible.isentropic_pressure_ratio")
```

### Excel
```excel
=ENG_COMPRESSIBLE_ISENTROPIC_PRESSURE_RATIO_M("...","...")
=ENG_FORMAT(ENG_COMPRESSIBLE_ISENTROPIC_PRESSURE_RATIO_M("...","..."),"<in_unit>","<out_unit>")
=ENG_EQUATION_ASCII("compressible.isentropic_pressure_ratio")
=ENG_EQUATION_TARGETS_TEXT("compressible.isentropic_pressure_ratio")
=ENG_EQUATION_VARIABLES_TABLE("compressible.isentropic_pressure_ratio")
=ENG_EQUATION_TARGET_COUNT("compressible.isentropic_pressure_ratio")
```
