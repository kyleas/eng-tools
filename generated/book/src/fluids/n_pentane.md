...
<table>
  ...
  <tbody>
    <tr><td>Key</td><td><code>nPentane</code></td></tr>
    <tr><td>Aliases</td><td><code>pentane</code>, <code>n-pentane</code></td></tr>
...
let state = fluids::n_pentane().state_tp("300 K", "1 bar")?;
