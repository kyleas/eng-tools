...
| [Conical Shock Calculator](./conical_shock_calc.md) | `conical_shock_calc` | Calculator-style compressible device for Taylor-Maccoll conical-shock workflows with explicit weak/strong branch handling. | Input forms: (M1, cone_angle), (M1, wave_angle), Taylor-Maccoll integrated conical-flow state resolution |
