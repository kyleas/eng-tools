...
Docs are the primary user interface for this library. Every core workflow example shown here is backed by compile-checked and/or executed test coverage.
...
**Library size:** 28 equations, 5 constants, 1 devices, 31 fluids, 2 materials.
