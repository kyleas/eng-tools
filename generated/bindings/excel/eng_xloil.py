...
@xloil.func(name="ENG_COMPRESSIBLE_AREA_MACH_M", help="Solve Isentropic Area-Mach Relation for M | Arguments: | - area_ratio: Area ratio | - gamma: Specific heat ratio | Returns: f64 | Example: =ENG_COMPRESSIBLE_AREA_MACH_M('...','...')")
...
@xloil.func(name="ENG_COMPRESSIBLE_AREA_MACH_AREA_RATIO", help="Solve Isentropic Area-Mach Relation for area_ratio | Arguments: | - m: Mach number | - gamma: Specific heat ratio | Returns: f64 | Example: =ENG_COMPRESSIBLE_AREA_MACH_AREA_RATIO('...','...')")
