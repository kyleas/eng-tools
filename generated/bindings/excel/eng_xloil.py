...
@xloil.func(name="ENG_CONICAL_SHOCK_PATH_TEXT", help="Conical shock calculator helper: compact step trace text | Arguments: | - m1: Upstream Mach number M1 | - input_kind: Input kind (cone_angle_deg or wave_angle_deg) | - input_value: Input angle value in degrees | - target_kind: Target kind (wave_angle_deg, cone_angle_deg, shock_turn_angle_deg, mc, p2_p1, rho2_rho1, t2_t1, p02_p01) | - gamma: Specific heat ratio | - branch: Weak/strong branch for cone-angle inversion paths | Returns: str | Example: =ENG_CONICAL_SHOCK_PATH_TEXT(2.2,'cone_angle_deg',12.0,'p2_p1',1.4,'weak')")
