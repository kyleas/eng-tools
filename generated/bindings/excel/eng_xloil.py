...
@xloil.func(name="ENG_ISENTROPIC_FROM_M_TO_NU_DEG", help="Convenience isentropic path: Mach -> nu(deg) | Arguments: | - value_in: Mach number | - gamma: Specific heat ratio | - branch: Optional branch (unused for this path) | Returns: f64 | Example: =ENG_ISENTROPIC_FROM_M_TO_NU_DEG(2.0,1.4,'')")
...
@xloil.func(name="ENG_ISENTROPIC_FROM_NU_DEG_TO_M", help="Convenience isentropic path: nu(deg) -> Mach | Arguments: | - value_in: Prandtl-Meyer angle in degrees | - gamma: Specific heat ratio | - branch: Optional branch (unused for this path) | Returns: f64 | Example: =ENG_ISENTROPIC_FROM_NU_DEG_TO_M(26.3797608134,1.4,'')")
