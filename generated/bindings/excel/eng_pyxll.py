...
@xl_func(name="ENG_CONICAL_SHOCK", doc="Conical shock calculator: (M1 + cone/wave angle) -> target with Taylor-Maccoll integration | Arguments: | - m1: Upstream Mach number M1 | - input_kind: Input kind (cone_angle_deg or wave_angle_deg) | - input_value: Input angle value in degrees | - target_kind: Target kind (wave_angle_deg, cone_angle_deg, shock_turn_angle_deg, mc, p2_p1, rho2_rho1, t2_t1, p02_p01) | - gamma: Specific heat ratio | - branch: Weak/strong branch for cone-angle inversion paths | Returns: f64 | Example: =ENG_CONICAL_SHOCK(2.2,'cone_angle_deg',12.0,'wave_angle_deg',1.4,'weak')")
def e_n_g_c_o_n_i_c_a_l_s_h_o_c_k(m1, input_kind, input_value, target_kind, gamma, branch=""):
    """Conical shock calculator: (M1 + cone/wave angle) -> target with Taylor-Maccoll integration | Arguments: | - m1: Upstream Mach number M1 | - input_kind: Input kind (cone_angle_deg or wave_angle_deg) | - input_value: Input angle value in degrees | - target_kind: Target kind (wave_angle_deg, cone_angle_deg, shock_turn_angle_deg, mc, p2_p1, rho2_rho1, t2_t1, p02_p01) | - gamma: Specific heat ratio | - branch: Weak/strong branch for cone-angle inversion paths | Returns: f64 | Example: =ENG_CONICAL_SHOCK(2.2,'cone_angle_deg',12.0,'wave_angle_deg',1.4,'weak')"""
...
@xl_func(name="ENG_CONICAL_SHOCK_FROM_M1_CONE_DEG_TO_MC", doc="Convenience conical-shock path: (M1, cone_angle_deg, branch) -> cone-surface Mach | Arguments: | - m1: Upstream Mach number M1 | - input_value: Cone angle in degrees | - gamma: Specific heat ratio | - branch: Weak or strong branch | Returns: f64 | Example: =ENG_CONICAL_SHOCK_FROM_M1_CONE_DEG_TO_MC(2.2,12.0,1.4,'weak')")
def e_n_g_c_o_n_i_c_a_l_s_h_o_c_k_f_r_o_m_m1_c_o_n_e_d_e_g_t_o_m_c(m1, input_value, gamma, branch=""):
    """Convenience conical-shock path: (M1, cone_angle_deg, branch) -> cone-surface Mach | Arguments: | - m1: Upstream Mach number M1 | - input_value: Cone angle in degrees | - gamma: Specific heat ratio | - branch: Weak or strong branch | Returns: f64 | Example: =ENG_CONICAL_SHOCK_FROM_M1_CONE_DEG_TO_MC(2.2,12.0,1.4,'weak')"""
...
@xl_func(name="ENG_CONICAL_SHOCK_FROM_M1_CONE_DEG_TO_P2_P1", doc="Convenience conical-shock path: (M1, cone_angle_deg, branch) -> p2/p1 | Arguments: | - m1: Upstream Mach number M1 | - input_value: Cone angle in degrees | - gamma: Specific heat ratio | - branch: Weak or strong branch | Returns: f64 | Example: =ENG_CONICAL_SHOCK_FROM_M1_CONE_DEG_TO_P2_P1(2.2,12.0,1.4,'weak')")
def e_n_g_c_o_n_i_c_a_l_s_h_o_c_k_f_r_o_m_m1_c_o_n_e_d_e_g_t_o_p2_p1(m1, input_value, gamma, branch=""):
    """Convenience conical-shock path: (M1, cone_angle_deg, branch) -> p2/p1 | Arguments: | - m1: Upstream Mach number M1 | - input_value: Cone angle in degrees | - gamma: Specific heat ratio | - branch: Weak or strong branch | Returns: f64 | Example: =ENG_CONICAL_SHOCK_FROM_M1_CONE_DEG_TO_P2_P1(2.2,12.0,1.4,'weak')"""
...
@xl_func(name="ENG_CONICAL_SHOCK_FROM_M1_CONE_DEG_TO_WAVE_DEG", doc="Convenience conical-shock path: (M1, cone_angle_deg, branch) -> wave_angle_deg | Arguments: | - m1: Upstream Mach number M1 | - input_value: Cone angle in degrees | - gamma: Specific heat ratio | - branch: Weak or strong branch | Returns: f64 | Example: =ENG_CONICAL_SHOCK_FROM_M1_CONE_DEG_TO_WAVE_DEG(2.2,12.0,1.4,'weak')")
def e_n_g_c_o_n_i_c_a_l_s_h_o_c_k_f_r_o_m_m1_c_o_n_e_d_e_g_t_o_w_a_v_e_d_e_g(m1, input_value, gamma, branch=""):
    """Convenience conical-shock path: (M1, cone_angle_deg, branch) -> wave_angle_deg | Arguments: | - m1: Upstream Mach number M1 | - input_value: Cone angle in degrees | - gamma: Specific heat ratio | - branch: Weak or strong branch | Returns: f64 | Example: =ENG_CONICAL_SHOCK_FROM_M1_CONE_DEG_TO_WAVE_DEG(2.2,12.0,1.4,'weak')"""
...
@xl_func(name="ENG_CONICAL_SHOCK_FROM_M1_WAVE_DEG_TO_CONE_DEG", doc="Convenience conical-shock path: (M1, wave_angle_deg) -> cone_angle_deg | Arguments: | - m1: Upstream Mach number M1 | - input_value: Input angle in degrees | - gamma: Specific heat ratio | Returns: f64 | Example: =ENG_CONICAL_SHOCK_FROM_M1_WAVE_DEG_TO_CONE_DEG(2.2,36.0,1.4)")
def e_n_g_c_o_n_i_c_a_l_s_h_o_c_k_f_r_o_m_m1_w_a_v_e_d_e_g_t_o_c_o_n_e_d_e_g(m1, input_value, gamma):
    """Convenience conical-shock path: (M1, wave_angle_deg) -> cone_angle_deg | Arguments: | - m1: Upstream Mach number M1 | - input_value: Input angle in degrees | - gamma: Specific heat ratio | Returns: f64 | Example: =ENG_CONICAL_SHOCK_FROM_M1_WAVE_DEG_TO_CONE_DEG(2.2,36.0,1.4)"""
...
@xl_func(name="ENG_CONICAL_SHOCK_PATH_TEXT", doc="Conical shock calculator helper: compact step trace text | Arguments: | - m1: Upstream Mach number M1 | - input_kind: Input kind (cone_angle_deg or wave_angle_deg) | - input_value: Input angle value in degrees | - target_kind: Target kind (wave_angle_deg, cone_angle_deg, shock_turn_angle_deg, mc, p2_p1, rho2_rho1, t2_t1, p02_p01) | - gamma: Specific heat ratio | - branch: Weak/strong branch for cone-angle inversion paths | Returns: str | Example: =ENG_CONICAL_SHOCK_PATH_TEXT(2.2,'cone_angle_deg',12.0,'p2_p1',1.4,'weak')")
def e_n_g_c_o_n_i_c_a_l_s_h_o_c_k_p_a_t_h_t_e_x_t(m1, input_kind, input_value, target_kind, gamma, branch=""):
    """Conical shock calculator helper: compact step trace text | Arguments: | - m1: Upstream Mach number M1 | - input_kind: Input kind (cone_angle_deg or wave_angle_deg) | - input_value: Input angle value in degrees | - target_kind: Target kind (wave_angle_deg, cone_angle_deg, shock_turn_angle_deg, mc, p2_p1, rho2_rho1, t2_t1, p02_p01) | - gamma: Specific heat ratio | - branch: Weak/strong branch for cone-angle inversion paths | Returns: str | Example: =ENG_CONICAL_SHOCK_PATH_TEXT(2.2,'cone_angle_deg',12.0,'p2_p1',1.4,'weak')"""
...
@xl_func(name="ENG_FANNO_FLOW_FROM_4FLSTAR_D_TO_M", doc="Convenience Fanno path: 4fL*/D -> Mach (branch required) | Arguments: | - input_value: Input ratio value | - gamma: Specific heat ratio | - branch: Subsonic or supersonic branch | Returns: f64 | Example: =ENG_FANNO_FLOW_FROM_4FLSTAR_D_TO_M(0.3049965026,1.4,'supersonic')")
...
@xl_func(name="ENG_FANNO_FLOW_FROM_M_TO_4FLSTAR_D", doc="Convenience Fanno path: Mach -> 4fL*/D | Arguments: | - input_value: Mach input value | - gamma: Specific heat ratio | Returns: f64 | Example: =ENG_FANNO_FLOW_FROM_M_TO_4FLSTAR_D(2.0,1.4)")
...
@xl_func(name="ENG_FANNO_FLOW_FROM_M_TO_P0_P0STAR", doc="Convenience Fanno path: Mach -> p0/p0* | Arguments: | - input_value: Mach input value | - gamma: Specific heat ratio | Returns: f64 | Example: =ENG_FANNO_FLOW_FROM_M_TO_P0_P0STAR(2.0,1.4)")
...
@xl_func(name="ENG_FANNO_FLOW_FROM_M_TO_P_PSTAR", doc="Convenience Fanno path: Mach -> p/p* | Arguments: | - input_value: Mach input value | - gamma: Specific heat ratio | Returns: f64 | Example: =ENG_FANNO_FLOW_FROM_M_TO_P_PSTAR(2.0,1.4)")
...
@xl_func(name="ENG_FANNO_FLOW_FROM_M_TO_RHO_RHOSTAR", doc="Convenience Fanno path: Mach -> rho/rho* | Arguments: | - input_value: Mach input value | - gamma: Specific heat ratio | Returns: f64 | Example: =ENG_FANNO_FLOW_FROM_M_TO_RHO_RHOSTAR(2.0,1.4)")
...
@xl_func(name="ENG_FANNO_FLOW_FROM_M_TO_T_TSTAR", doc="Convenience Fanno path: Mach -> T/T* | Arguments: | - input_value: Mach input value | - gamma: Specific heat ratio | Returns: f64 | Example: =ENG_FANNO_FLOW_FROM_M_TO_T_TSTAR(2.0,1.4)")
...
@xl_func(name="ENG_FANNO_FLOW_FROM_M_TO_V_VSTAR", doc="Convenience Fanno path: Mach -> V/V* | Arguments: | - input_value: Mach input value | - gamma: Specific heat ratio | Returns: f64 | Example: =ENG_FANNO_FLOW_FROM_M_TO_V_VSTAR(2.0,1.4)")
...
@xl_func(name="ENG_FANNO_FLOW_FROM_P0_P0STAR_TO_M", doc="Convenience Fanno path: p0/p0* -> Mach (branch required) | Arguments: | - input_value: Input ratio value | - gamma: Specific heat ratio | - branch: Subsonic or supersonic branch | Returns: f64 | Example: =ENG_FANNO_FLOW_FROM_P0_P0STAR_TO_M(1.33984375,1.4,'subsonic')")
...
@xl_func(name="ENG_NOZZLE_FLOW_FROM_A_ASTAR_TO_M", doc="Convenience nozzle-flow path: A/A* -> Mach (branch required) | Arguments: | - input_value: Area ratio input value (A/A*) | - gamma: Specific heat ratio | - branch: Subsonic or supersonic branch | Returns: f64 | Example: =ENG_NOZZLE_FLOW_FROM_A_ASTAR_TO_M(2.0,1.4,'supersonic')")
...
@xl_func(name="ENG_NOZZLE_FLOW_FROM_M_TO_A_ASTAR", doc="Convenience nozzle-flow path: Mach -> A/A* | Arguments: | - input_value: Mach input value | - gamma: Specific heat ratio | Returns: f64 | Example: =ENG_NOZZLE_FLOW_FROM_M_TO_A_ASTAR(2.0,1.4)")
...
@xl_func(name="ENG_NOZZLE_FLOW_FROM_M_TO_P_P0", doc="Convenience nozzle-flow path: Mach -> p/p0 | Arguments: | - input_value: Mach input value | - gamma: Specific heat ratio | Returns: f64 | Example: =ENG_NOZZLE_FLOW_FROM_M_TO_P_P0(2.0,1.4)")
...
@xl_func(name="ENG_NOZZLE_FLOW_FROM_M_TO_RHO_RHO0", doc="Convenience nozzle-flow path: Mach -> rho/rho0 | Arguments: | - input_value: Mach input value | - gamma: Specific heat ratio | Returns: f64 | Example: =ENG_NOZZLE_FLOW_FROM_M_TO_RHO_RHO0(2.0,1.4)")
...
@xl_func(name="ENG_NOZZLE_FLOW_FROM_M_TO_T_T0", doc="Convenience nozzle-flow path: Mach -> T/T0 | Arguments: | - input_value: Mach input value | - gamma: Specific heat ratio | Returns: f64 | Example: =ENG_NOZZLE_FLOW_FROM_M_TO_T_T0(2.0,1.4)")
...
@xl_func(name="ENG_COMPRESSIBLE_FANNO_DENSITY_RATIO_M", doc="Solve Fanno Density Ratio for M | Arguments: | - rho_rhostar: Density ratio to star state | - gamma: Specific heat ratio | - branch: Optional branch selection. Supported: subsonic, supersonic | Returns: f64 | Example: =ENG_COMPRESSIBLE_FANNO_DENSITY_RATIO_M('...','...','...')")
...
@xl_func(name="ENG_COMPRESSIBLE_FANNO_DENSITY_RATIO_RHO_RHOSTAR", doc="Solve Fanno Density Ratio for rho_rhostar | Arguments: | - m: Mach number | - gamma: Specific heat ratio | - branch: Optional branch selection. Supported: subsonic, supersonic | Returns: f64 | Example: =ENG_COMPRESSIBLE_FANNO_DENSITY_RATIO_RHO_RHOSTAR('...','...','...')")
...
@xl_func(name="ENG_COMPRESSIBLE_FANNO_FRICTION_PARAMETER_M", doc="Solve Fanno Friction Length Parameter for M | Arguments: | - four_flstar_d: Fanno friction length parameter | - gamma: Specific heat ratio | - branch: Optional branch selection. Supported: subsonic, supersonic | Returns: f64 | Example: =ENG_COMPRESSIBLE_FANNO_FRICTION_PARAMETER_M('...','...','...')")
...
@xl_func(name="ENG_COMPRESSIBLE_FANNO_PRESSURE_RATIO_M", doc="Solve Fanno Pressure Ratio for M | Arguments: | - p_pstar: Pressure ratio to star state | - gamma: Specific heat ratio | - branch: Optional branch selection. Supported: subsonic, supersonic | Returns: f64 | Example: =ENG_COMPRESSIBLE_FANNO_PRESSURE_RATIO_M('...','...','...')")
...
@xl_func(name="ENG_COMPRESSIBLE_FANNO_PRESSURE_RATIO_P_PSTAR", doc="Solve Fanno Pressure Ratio for p_pstar | Arguments: | - m: Mach number | - gamma: Specific heat ratio | - branch: Optional branch selection. Supported: subsonic, supersonic | Returns: f64 | Example: =ENG_COMPRESSIBLE_FANNO_PRESSURE_RATIO_P_PSTAR('...','...','...')")
...
@xl_func(name="ENG_COMPRESSIBLE_FANNO_STAGNATION_PRESSURE_RATIO_M", doc="Solve Fanno Stagnation Pressure Ratio for M | Arguments: | - p0_p0star: Stagnation pressure ratio to star state | - gamma: Specific heat ratio | - branch: Optional branch selection. Supported: subsonic, supersonic | Returns: f64 | Example: =ENG_COMPRESSIBLE_FANNO_STAGNATION_PRESSURE_RATIO_M('...','...','...')")
...
@xl_func(name="ENG_COMPRESSIBLE_FANNO_STAGNATION_PRESSURE_RATIO_P0_P0STAR", doc="Solve Fanno Stagnation Pressure Ratio for p0_p0star | Arguments: | - m: Mach number | - gamma: Specific heat ratio | - branch: Optional branch selection. Supported: subsonic, supersonic | Returns: f64 | Example: =ENG_COMPRESSIBLE_FANNO_STAGNATION_PRESSURE_RATIO_P0_P0STAR('...','...','...')")
...
@xl_func(name="ENG_COMPRESSIBLE_FANNO_TEMPERATURE_RATIO_M", doc="Solve Fanno Temperature Ratio for M | Arguments: | - t_tstar: Temperature ratio to star state | - gamma: Specific heat ratio | - branch: Optional branch selection. Supported: subsonic, supersonic | Returns: f64 | Example: =ENG_COMPRESSIBLE_FANNO_TEMPERATURE_RATIO_M('...','...','...')")
...
@xl_func(name="ENG_COMPRESSIBLE_FANNO_TEMPERATURE_RATIO_T_TSTAR", doc="Solve Fanno Temperature Ratio for t_tstar | Arguments: | - m: Mach number | - gamma: Specific heat ratio | - branch: Optional branch selection. Supported: subsonic, supersonic | Returns: f64 | Example: =ENG_COMPRESSIBLE_FANNO_TEMPERATURE_RATIO_T_TSTAR('...','...','...')")
...
@xl_func(name="ENG_COMPRESSIBLE_FANNO_VELOCITY_RATIO_M", doc="Solve Fanno Velocity Ratio for M | Arguments: | - v_vstar: Velocity ratio to star state | - gamma: Specific heat ratio | - branch: Optional branch selection. Supported: subsonic, supersonic | Returns: f64 | Example: =ENG_COMPRESSIBLE_FANNO_VELOCITY_RATIO_M('...','...','...')")
...
@xl_func(name="ENG_COMPRESSIBLE_FANNO_VELOCITY_RATIO_V_VSTAR", doc="Solve Fanno Velocity Ratio for v_vstar | Arguments: | - m: Mach number | - gamma: Specific heat ratio | - branch: Optional branch selection. Supported: subsonic, supersonic | Returns: f64 | Example: =ENG_COMPRESSIBLE_FANNO_VELOCITY_RATIO_V_VSTAR('...','...','...')")
...
@xl_func(name="ENG_STUDY_ISENTROPIC_M_TO_P_P0_TABLE", doc="Study table for isentropic device Mach -> p/p0 | Arguments: | - gamma: Specific heat ratio | - start: Mach start | - end: Mach end | - count: Sample count | - branch: Optional branch | Returns: dict(table, spill) | Example: =ENG_STUDY_ISENTROPIC_M_TO_P_P0_TABLE(1.4,0.2,3,21,'')")
...
@xl_func(name="ENG_STUDY_NORMAL_SHOCK_TABLE", doc="Study table for normal-shock device over M1 | Arguments: | - gamma: Specific heat ratio | - start: M1 start | - end: M1 end | - count: Sample count | Returns: dict(table, spill) | Example: =ENG_STUDY_NORMAL_SHOCK_TABLE(1.4,1.05,4,20)")
...
@xl_func(name="ENG_STUDY_NOZZLE_FLOW_TABLE", doc="Study table for nozzle-flow device over area ratio | Arguments: | - gamma: Specific heat ratio | - start: Area-ratio start | - end: Area-ratio end | - count: Sample count | - branch: Branch (subsonic/supersonic) | Returns: dict(table, spill) | Example: =ENG_STUDY_NOZZLE_FLOW_TABLE(1.4,1.2,3,20,'supersonic')")
...
@xl_func(name="ENG_STUDY_DEVICE_TABLE", doc="Generic metadata-driven device study table | Arguments: | - device_key: Device key (for example nozzle_flow_calc) | - sweep_arg: Numeric argument name to sweep | - start: Sweep start | - end: Sweep end | - count: Sample count | - fixed_args: JSON object string for fixed args | - outputs: Optional output list string (comma separated: value,pivot,path_text) | Returns: dict(table, spill) | Example: =ENG_STUDY_DEVICE_TABLE('nozzle_flow_calc','input_value',1.2,3,10,'{''input_kind'':''area_ratio'',''target_kind'':''mach'',''gamma'':1.4,''branch'':''supersonic''}','value,pivot,path_text')")
def e_n_g_s_t_u_d_y_d_e_v_i_c_e_t_a_b_l_e(device_key, sweep_arg, start, end, count, fixed_args, outputs):
    """Generic metadata-driven device study table | Arguments: | - device_key: Device key (for example nozzle_flow_calc) | - sweep_arg: Numeric argument name to sweep | - start: Sweep start | - end: Sweep end | - count: Sample count | - fixed_args: JSON object string for fixed args | - outputs: Optional output list string (comma separated: value,pivot,path_text) | Returns: dict(table, spill) | Example: =ENG_STUDY_DEVICE_TABLE('nozzle_flow_calc','input_value',1.2,3,10,'{''input_kind'':''area_ratio'',''target_kind'':''mach'',''gamma'':1.4,''branch'':''supersonic''}','value,pivot,path_text')"""
    return invoke("study.device.sweep", {"output": "spill", "device_key": device_key, "sweep_arg": sweep_arg, "start": start, "end": end, "count": count, "fixed_args": fixed_args, "outputs": outputs})

@xl_func(name="ENG_STUDY_EQUATION_TABLE", doc="Generic equation study sweep table (1D axis) | Arguments: | - path_id: Equation path id | - target: Solve target key | - sweep_variable: Variable to sweep | - start: Sweep start | - end: Sweep end | - count: Number of samples | - spacing: Spacing mode (linear or logspace) | - branch: Optional branch | Returns: dict(table, spill) | Example: =ENG_STUDY_EQUATION_TABLE('compressible.isentropic_pressure_ratio','p_p0','M',0.2,3,20,'linear','')")
...
@xl_func(name="ENG_STUDY_NOZZLE_NORMAL_SHOCK_WORKFLOW_TABLE", doc="Study table for nozzle + normal-shock chained workflow | Arguments: | - gamma: Specific heat ratio | - start: Area-ratio start | - end: Area-ratio end | - count: Sample count | - branch: Nozzle branch (subsonic/supersonic) | Returns: dict(table, spill) | Example: =ENG_STUDY_NOZZLE_NORMAL_SHOCK_WORKFLOW_TABLE(1.4,1.2,3,20,'supersonic')")
...
@xl_func(name="ENG_STUDY_WORKFLOW_TABLE", doc="Generic workflow-chain study table | Arguments: | - workflow_key: Workflow key (for example nozzle_normal_shock_chain) | - sweep_arg: Numeric argument name to sweep | - start: Sweep start | - end: Sweep end | - count: Sample count | - fixed_args: JSON object string for fixed args | Returns: dict(table, spill) | Example: =ENG_STUDY_WORKFLOW_TABLE('nozzle_normal_shock_chain','area_ratio',1.2,3,12,'{''gamma'':1.4,''branch'':''supersonic''}')")
def e_n_g_s_t_u_d_y_w_o_r_k_f_l_o_w_t_a_b_l_e(workflow_key, sweep_arg, start, end, count, fixed_args):
    """Generic workflow-chain study table | Arguments: | - workflow_key: Workflow key (for example nozzle_normal_shock_chain) | - sweep_arg: Numeric argument name to sweep | - start: Sweep start | - end: Sweep end | - count: Sample count | - fixed_args: JSON object string for fixed args | Returns: dict(table, spill) | Example: =ENG_STUDY_WORKFLOW_TABLE('nozzle_normal_shock_chain','area_ratio',1.2,3,12,'{''gamma'':1.4,''branch'':''supersonic''}')"""
    return invoke("study.workflow.sweep", {"output": "spill", "workflow_key": workflow_key, "sweep_arg": sweep_arg, "start": start, "end": end, "count": count, "fixed_args": fixed_args})
